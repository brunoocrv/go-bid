...
SELECT id, product_id, bidder_id, amount, created_at FROM bids WHERE product_id = $1 ORDER BY amount DESC
`
...
SELECT id, product_id, bidder_id, amount, created_at FROM bids WHERE product_id = $1 ORDER BY amount DESC LIMIT 1
`
